...
function CustomersTotalTransactions(props) {
    ...
    return <section>  {/* Used or (||) operator to return the amount directly if the customer made only one transaction as the reduce method returns an object if the array has only one element */}
